...
export const MOCK_POSTS = [
  ...
  },
  {
    ...
    replay_data: {
      ...
      savedGame: {
        sbAmount: 1, bbAmount: 2, heroIndex: 0, potSize: 121,
        heroCards: [{ rank: 'A', suit: 's' }, { rank: 'A', suit: 'h' }],
        ...
        history: [
          ...
          { player: 'Hero',    isHero: true,  action: 'Raise to 72', round: '河牌 (River)',    pot: 121 },
          { player: 'Player2', isHero: false, action: 'Fold',        round: '河牌 (River)',    pot: 121 },
          { isDivider: true,   text: '--- 结算 ---', cards: [] },
          { isWinLog: true,    action: 'Hero 赢下底池 $121',          pot: 121 },
        ],
      },
    },
  },
